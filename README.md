...
| **Learning Rate Sweep (W&B Integration)** | Conduct a learning rate sweep on MNIST classification and log results to Weights & Biases | [lr_sweep_early_stopping.ipynb](notebooks/lr_sweep_early_stopping.ipynb) | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/michalszc/torch-batteries/blob/master/notebooks/lr_sweep_early_stopping.ipynb) |
| **Experiment Tracking Integration** | Demonstrates integration with TensorBoard and Weights & Biases for experiment tracking | [tracking_integration.ipynb](notebooks/tracking_integration.ipynb) | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/michalszc/torch-batteries/blob/master/notebooks/tracking_integration.ipynb) |
