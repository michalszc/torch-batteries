...
Start with **Function Fitting with MLP** for the shortest end-to-end introduction.
Continue with **Image Classification with CNN** for callbacks and checkpoints, then
